(function () {
    ...
    function getProxyServerUrl() {
      // URL backend прокси-сервера для проксирования запросов
    ...
    function GetInfo$3() {
      ...
      return new Promise(function (resolve, reject) {
        // Используем backend прокси-сервер
        var requestPromise = makeRequestViaProxy(targetUrl, "GET", getHeaders$3(), null);
    ...
    function SendCommand$3(btn, torrent_data) {
      return new Promise(function (resolve, reject) {
        ...
        // Используем backend прокси-сервер
        var versionPromise = makeRequestViaProxy(versionUrl, "GET", getHeaders$3(), null);
        ...
        versionPromise.then(function (version) {
          ...
          // Используем backend прокси-сервер
          var commandPromise = makeRequestViaProxy(commandUrl, "POST", getHeaders$3("application/x-www-form-urlencoded"), commandData);
    ...
    function SendTask$3(selectedTorrent, labels, dtype) {
      ...
      return new Promise(function (resolve, reject) {
        // Используем backend прокси-сервер
        var requestPromise = makeRequestViaProxy(targetUrl, "POST", getHeaders$3("application/x-www-form-urlencoded"), taskData);
    ...
    function _setTags() {
      _setTags = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(torrentId, tags) {
        var tagValue, url, tagsUrl, tagsData;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              ...
              // Используем backend прокси-сервер
              return _context3.a(2, makeRequestViaProxy(tagsUrl, "POST", getHeaders$3("application/x-www-form-urlencoded"), tagsData));
          }
        }, _callee3);
      }));
      return _setTags.apply(this, arguments);
